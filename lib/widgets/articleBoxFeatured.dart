...
//                ),
        ...
        Positioned(left: 20, top: 80, right: 20,
          child: Container(
            ...
            child: Padding(
              ...
              child: Card(
                child: Container(
                  padding: EdgeInsets.fromLTRB(8, 16, 8, 10),
                  child: Column(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              child: Row(
                                children: <Widget>[
                                  Icon(Icons.timer, color: Colors.black45, size: 12.0,),
                                  SizedBox(width: 4,),
...
//        article.video != "" ? Positioned(left: 18, top: 18,
//                child: Card(
